...
import { SalesTechniques } from "@/components/sales-techniques"
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl font-bold">Técnicas de Venda</h1>
              </div>
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-3xl font-bold text-balance">Técnicas de Venda 📚</h2>
              <p className="text-muted-foreground text-balance">
                Aprenda e domine as principais técnicas de vendas para aumentar sua performance e conquistar mais
                clientes
              </p>
            </div>
